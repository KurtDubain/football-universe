...
- A later 2026-09-08 experience-convergence audit superseded the current recommendation with `20260709`. The shared scorer now mildly favors the default challenger lens, rewards one to three early World Moments and meaningful opener events, and penalizes both zero and excessive early moments; the historical v4.55.0 result above remains recorded as its release-time evidence.
