...
| `story-dark-horse-v1.webp` | Dark-horse chapter mark | `call_gRmi88th7TQKhmIcigRMcBcG.png` | 192x192 | 4 KB |
| `story-giant-crisis-v1.webp` | Giant-crisis chapter mark | `call_NF28WRXQiLvdSm7d9BOrJjmX.png` | 192x192 | 4 KB |
...
- Story marks: one shared engraved broadcast family for an underdog rise, a
  fractured giant crown, and a promoted side holding above the survival line.
